...
class InputConfig(ModelConfigBlock):
    ...
    def generate_input_config(cls,values):
        ...
        assert values["format"]  == model_config.ModelInput.FORMAT_NCHW or values["format"]  == model_config.ModelInput.FORMAT_NHWC,\
        ...
        input_metadata_shape , has_input_batch_dim = values["input_metadata_shape"] , values["has_input_batch_dim"]
...
class ModelConfig(BaseModel):
    ...
    def generate_input_config(cls,values):
        ...
        values["input_config"] = InputConfig(input_metadata_shape=values["input_metadata_shape"],
...
class ModelMetadata(BaseModel):
    ...
    def check_input_metadata_dims(cls, inputs, values):
        ...
        assert len(input_metadata.shape) == expected_input_dims,f"expecting input to have {expected_input_dims} dimensions, input has { len(input_metadata.shape)}"
        return inputs
